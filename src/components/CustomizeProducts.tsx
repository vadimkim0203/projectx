  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex items-center gap-3">
        <li className="w-8 h-8 rounded-full ring-1 ring-gray-300 cursor-pointer bg-[#616b79] relative">
      ...
      <ul className="flex items-center gap-3">
        ...
        <li className="ring-1 ring-gray-300 text-white bg-gray-500 rounded-md py-1 px-4 text-sm   cursor-not-allowed ">
          250
        </li>
      </ul>
    </div>
